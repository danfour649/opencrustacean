...
final class ShareComposeView: UIView, UITextViewDelegate {
    ...
    func apply(_ status: ShareComposeStatus) {
        ...
        case .sending:
            self.showFooter(
                text: NSLocalizedString("Sending to OpenCrustacean gateway…", comment: "Share extension sending status"),
                icon: nil,
                spinning: true)
        case .sent:
            self.showFooter(
                text: NSLocalizedString("Sent to OpenCrustacean.", comment: "Share extension success status"),
    ...
    private func configureSubviews() {
        ...
        self.titleLabel.text = "OpenCrustacean"
    ...
    private static func makeSendConfiguration() -> UIButton.Configuration {
        ...
        configuration.attributedTitle = self.attributedTitle(
            NSLocalizedString("Send to OpenCrustacean", comment: "Share extension send action"),
            style: .headline)
